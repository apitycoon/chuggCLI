...
var searchWebpackLoaders = require('../searchWebpackLoaders.js');
...
test('testing searchWebpackloader function', function (t) {
  t.plan(3);

  // check multiple results
  t.deepEqual(searchWebpackLoaders('json', data), [{
    name: 'json',
    url: 'n/a',
    desc: 'loads file as JSON'
  }, {
  ...
  t.deepEqual(searchWebpackLoaders('css', data), [{
    name: 'css',
    url: 'n/a',
    desc: 'Loads css file with resolved imports and returns css code'
  ...
  t.deepEqual(searchWebpackLoaders('akljads;fjasdkf', data), [], 'testing for an empty result');
});